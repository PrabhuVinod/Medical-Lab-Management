<div class="patients index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('refdoc'); ?></th>
			<th><?php echo $this->Paginator->sort('phone'); ?></th>
			<th><?php echo $this->Paginator->sort('testdate'); ?></th>
			<th><?php echo $this->Paginator->sort('resultdate'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($patient['Patient']['refdoc']); ?>&nbsp;</td>
		<td><?php echo h($patient['Patient']['phone']); ?>&nbsp;</td>
		<td><?php echo h($patient['Patient']['testdate']); ?>&nbsp;</td>
		<td><?php echo h($patient['Patient']['resultdate']); ?>&nbsp;</td>
		<td><?php echo h($patient['Patient']['advance']); ?>&nbsp;</td>
